...
public class Administrador {
 Consultador consultador;
	...
	private void realizarVenta(Cliente cliente, int numPedido) {
	...
	public void populateClientes(JComboBox listaClientes) {
		ArrayList<Cliente> listarClientes = new Consultador().listarClientes();
		//TODO: recibe clientes de la base de datos y los muestra en en combobox
	}
}
